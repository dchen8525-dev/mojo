export interface ModelInfo {
  ...
  maxOutput: number;
  /** Multi-modal: the model accepts image blocks in messages. */
  vision?: boolean;
...
const KNOWN: Array<[RegExp, ModelInfo]> = [
  [/^claude-sonnet-4-5/, { contextWindow: 200_000, maxOutput: 8192, vision: true, inputPerMTok: 3, outputPerMTok: 15, cacheReadPerMTok: 0.3, cacheWritePerMTok: 3.75 }],
  [/^claude-opus-4-1/, { contextWindow: 200_000, maxOutput: 8192, vision: true, inputPerMTok: 15, outputPerMTok: 75, cacheReadPerMTok: 1.5, cacheWritePerMTok: 18.75 }],
  [/^claude-haiku-4-5/, { contextWindow: 200_000, maxOutput: 8192, vision: true, inputPerMTok: 1, outputPerMTok: 5, cacheReadPerMTok: 0.1, cacheWritePerMTok: 1.25 }],
  [/^claude-(opus|sonnet|haiku)/, { contextWindow: 200_000, maxOutput: 8192, vision: true }],
  [/^claude-3/, { contextWindow: 200_000, maxOutput: 4096, vision: true }],
  [/^gpt-4\.1/, { contextWindow: 1_000_000, maxOutput: 32_768, inputPerMTok: 2, outputPerMTok: 8, cacheReadPerMTok: 0.5 }],
  [/^gpt-4o-mini/, { contextWindow: 128_000, maxOutput: 16_384, vision: true, inputPerMTok: 0.15, outputPerMTok: 0.6, cacheReadPerMTok: 0.075 }],
  [/^gpt-4o/, { contextWindow: 128_000, maxOutput: 16_384, vision: true, inputPerMTok: 2.5, outputPerMTok: 10, cacheReadPerMTok: 1.25 }],
  [/^(o1|o3|o4)(-|$)/, { contextWindow: 200_000, maxOutput: 100_000, vision: true, reasoning: true }],
